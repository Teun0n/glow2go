...
class Zigbee2mqttMessage:
    ...
    # can be observed in the parse() method, where instances of Zigbee2mqttMessage are created
    ...
    def parse(cls, topic: str, message: str) -> Zigbee2mqttMessage:
        ...
        Returns:
            Zigbee2mqttMessage: an object with the parsed message values
        """
        # A note about class methods: these methods can be used to instantiate the class where it is
        # declared. In this case, this method returns an instance of Zigbee2mqttMessage based on
